<%-- 
    Document   : board
    Created on : 2020. 12. 3., 오후 9:10:41
    Author     : hyeon
--%>
                        ...
                        <center><h1 id="navbars" onclick="location.href = 'index.jsp'">Homework Calendar</h1><center>
                               ...
                               ================================================== 끝-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <center><p style="font-size: 30px">경영정보학과 게시판</p></center>
                                        <div class="container">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td><a href="read.jsp?boardType=1&number=<%=rs.getInt("number")%>"><%=rs.getString("title")%></a></td>
