<%-- 
    Document   : board2
    Created on : 2020. 12. 3., 오후 9:11:17
    Author     : hyeon
--%>
                        ...
                        <center><h1 id="navbars" onclick="location.href = 'index.jsp'">Homework Calendar</h1><center>
                               ...
                               ================================================== 끝-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <center><p style="font-size: 30px">e비즈니스학과 게시판</p></center>
                                        <div class="container">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <td><a href="read.jsp?boardType=2&number=<%=rs.getInt("number")%>"><%=rs.getString("title")%></a></td>
                                            ...
                                            <button class="btn btn-secondary my-2 my-sm-0" type="submit" onclick="window.location.href='write.jsp?major=2'">글쓰기</button>
                                        </div>
                                        <br />
                                    </div>
