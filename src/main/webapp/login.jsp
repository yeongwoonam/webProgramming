...
<center><h2>id&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : <input type="text" id="id" onchange="checkID(this)"></h2></center><br>
<center><h2>password : <input type="password" id="password"></h2></center><br>
<center><button class="btn btn-secondary my-2 my-sm-0" onclick="submit()">로그인</button></center>
</body>
</html>
